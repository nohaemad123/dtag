...
$(document).ready(function () {
    ...
    var windowHeight = $(window).height(),
        ...
        upperbar = $(".ts-top-bar").innerHeight(),
        nav = $(".ts-header").innerHeight();
    $(".background").height(windowHeight);
    $("#background2").height((windowHeight - (upperbar + nav)) + 20);
    $(".background2").height(windowHeight / 2.3);
    ...
    //
    //        var has = $(this);
    //        if (has.hasClass('show')) {
    //            $(this).find('i').removeClass('fa-minus');
    //            $(this).find('i').addClass('fa-plus');
    //            $(this).siblings().removeClass('fa-minus').addClass('fa-plus');
    //        } else {
